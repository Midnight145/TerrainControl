...
public class ForgeEngine extends TerrainControlEngine {
	 ...
	 *         loaded.
	 */
	public LocalWorld getWorld() { return worldType.worldTC; }
	...
	public LocalMaterialData readMaterial(String input) throws InvalidConfigException {
		...
		if (block != null) { return ForgeMaterialData.ofMinecraftBlock(block, 0); }
	...
	private LocalMaterialData getMaterial0(String input) throws NumberFormatException, InvalidConfigException {
		...
		if (block != null) { return ForgeMaterialData.ofMinecraftBlock(block, blockData); }
		DefaultMaterial defaultMaterial = DefaultMaterial.getMaterial(blockName);
		if (defaultMaterial != DefaultMaterial.UNKNOWN_BLOCK) { return ForgeMaterialData.ofDefaultMaterial(defaultMaterial, blockData); }
