...
public class TCWorldChunkManager extends WorldChunkManager {
	...
	@Override
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] paramArrayOfBiomeBase, int paramInt1, int paramInt2, int paramInt3,
			int paramInt4) {
	...
	@Override
	public BiomeGenBase[] getBiomeGenAt(BiomeGenBase[] paramArrayOfBiomeBase, int paramInt1, int paramInt2, int paramInt3, int paramInt4,
	...
	public boolean areBiomesViable(int paramInt1, int paramInt2, int paramInt3, List paramList) {
		...
		// code)
		if (paramList == MapGenVillage.villageSpawnBiomes) { paramList = localWorld.villageGen.villageSpawnBiomes; }
