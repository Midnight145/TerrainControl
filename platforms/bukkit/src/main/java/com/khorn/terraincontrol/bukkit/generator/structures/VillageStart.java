...
public class VillageStart extends StructureStart {
	...
	public VillageStart(World world, Random random, int chunkX, int chunkZ, int size) {
		...
		WorldGenVillageStartPiece startPiece = new WorldGenVillageStartPiece(world.getWorldChunkManager(), 0, random, startX, startZ,
				villagePieces, size);
		...
		for (Object anA : this.a) {
			...
			if (!(structurepiece1 instanceof WorldGenVillageRoadPiece)) { ++componentCount; }
		}
