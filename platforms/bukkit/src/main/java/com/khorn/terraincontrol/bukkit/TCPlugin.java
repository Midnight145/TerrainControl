	...
	public void onEnable() {
		...
		if (!Bukkit.getWorlds().isEmpty() && !cleanupOnDisable) {
			...
			TerrainControl.log(LogMarker.FATAL,
					Arrays.asList("The server was just /reloaded! Terrain Control has problems handling this, ",
	...
	public ChunkGenerator getDefaultWorldGenerator(String worldName, String id) {
		if (worldName.isEmpty()) {
			TerrainControl.log(LogMarker.DEBUG,
					"Ignoring empty world name. Is some generator plugin checking if \"TerrainControl\" is a valid world name?");
			return new TCChunkGenerator(this);
		}
		if (worldName.equals("test")) {
			TerrainControl.log(LogMarker.DEBUG, "Ignoring world with the name \"test\". This is not a valid world name, ",
