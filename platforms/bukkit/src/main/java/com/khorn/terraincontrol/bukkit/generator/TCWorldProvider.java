 ...
 * In Minecraft this is used in a few places such as spawning algorithms for
 * villages.
 * The value seem to be hardcoded in CraftWorld and we are a bit unsure about if
 * that matters.
...
public class TCWorldProvider extends WorldProviderNormal {
	...
	@Override
	public int getSeaLevel() { return localWorld.getConfigs().getWorldConfig().waterLevelMax; }
	 ...
	 */
	public WorldProvider getOldWorldProvider() { return oldWorldProvider; }
}