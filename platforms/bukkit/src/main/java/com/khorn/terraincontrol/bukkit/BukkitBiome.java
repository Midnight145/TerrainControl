...
public class BukkitBiome implements LocalBiome {
	...
	public BiomeBase getHandle() { return biomeBase; }

	@Override
	public void setEffects() {
		if (isCustom) { ((CustomBiome) this.biomeBase).setEffects(this.biomeConfig); }
	}

	@Override
	public String getName() { return this.biomeConfig.getName(); }

	@Override
	public BiomeIds getIds() { return this.biomeIds; }
	...
	@Override
	public BiomeConfig getBiomeConfig() { return this.biomeConfig; }
