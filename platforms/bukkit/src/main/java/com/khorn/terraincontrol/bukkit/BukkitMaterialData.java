...
public class BukkitMaterialData implements LocalMaterialData {
	...
	@Override
	public int getBlockId() { return Block.getId(block); }
	...
	public String getName() {
		...
		if (defaultMaterial == DefaultMaterial.UNKNOWN_BLOCK) {
			...
			if (data != 0) { return Block.REGISTRY.c(block) + ":" + data; }
	...
	public LocalMaterialData rotate() {
		...
		if (defaultMaterial != DefaultMaterial.UNKNOWN_BLOCK) {
			...
			if (newData != data) { return new BukkitMaterialData(block, newData); }
		}
