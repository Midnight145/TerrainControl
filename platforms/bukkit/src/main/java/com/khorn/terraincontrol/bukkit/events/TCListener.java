...
public class TCListener implements Listener {
	...
	public void onPlayerRegisterChannel(PlayerRegisterChannelEvent event) {
		...
		if (event.getChannel().equals(PluginStandardValues.ChannelName)) { tcSender.send(event.getPlayer()); }
	}
	...
	public void onPlayerChangedWorld(PlayerChangedWorldEvent event) {
		...
		if (player.getListeningPluginChannels().contains(PluginStandardValues.ChannelName)) { tcSender.send(player); }
	}
