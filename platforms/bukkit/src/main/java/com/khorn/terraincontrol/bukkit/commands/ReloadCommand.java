...
public class ReloadCommand extends BaseCommand {
	...
	public boolean onCommand(CommandSender sender, List<String> args) {
		...
		if (world == null) {
			sender.sendMessage(
					ERROR_COLOR + "World not found. Either you are not in a world with Terrain Control, or you are the console.");
			return false;
		}
		...
		if (sender instanceof Player) {
			TerrainControl.log(LogMarker.INFO, "{} reloaded the config files for world '{}'.",
					new Object[] { sender.getName(), world.getName() });
		}
		return true;
	}
