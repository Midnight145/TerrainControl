...
public final class BukkitMojangSettings implements MojangSettings {
	...
	@Override
	public float getWetness() { return biomeBase.humidity; }

	@Override
	public float getSurfaceHeight() { return biomeBase.am; }

	@Override
	public float getSurfaceVolatility() { return biomeBase.an; }

	@Override
	public LocalMaterialData getSurfaceBlock() { return BukkitMaterialData.ofMinecraftBlock(biomeBase.ai, 0); }

	@Override
	public LocalMaterialData getGroundBlock() { return BukkitMaterialData.ofMinecraftBlock(biomeBase.ak, 0); }
