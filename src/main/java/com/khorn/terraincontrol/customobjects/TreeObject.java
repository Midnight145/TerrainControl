...
public class TreeObject implements CustomObject {
	private static class TreeSettings extends Settings {
		static final Setting<Integer> MIN_HEIGHT = intSetting("MinHeight", TerrainControl.WORLD_DEPTH, TerrainControl.WORLD_DEPTH,
				TerrainControl.WORLD_HEIGHT);
		static final Setting<Integer> MAX_HEIGHT = intSetting("MaxHeight", TerrainControl.WORLD_HEIGHT, TerrainControl.WORLD_DEPTH,
				TerrainControl.WORLD_HEIGHT);
	}
