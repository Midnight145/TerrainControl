...
public class CustomObjectCollection implements Iterable<CustomObject> {
	...
	/**
	 * Creates a new {@link CustomObjectCollection} instance that loads the objects
	 * immediately.
	 * 
	...
	public void load(Map<String, CustomObjectLoader> loaders, File directory) {
		if (!FileHelper.makeFolder(directory)) { return; }
	 ...
	 */
	public void setFallback(CustomObjectCollection customObjects) { this.fallback = customObjects; }
	...
	public CustomObject getObjectByName(String name) {
		...
		if (object == null && fallback != null) { return fallback.getObjectByName(name); }
		return object;
	}
	 ...
	 * @return A view.
	 */
	public List<CustomObject> getAll() { return Collections.unmodifiableList(objects); }
