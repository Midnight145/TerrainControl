...
public abstract class EventHandler {
	 ...
	 * @param chunkX         The x coordinate of the chunk the resource will spawn
	 *                       in.
	 * @param chunkZ         The z coordinate of the chunk the resource will spawn
	 *                       in.
	 * @return Whether the event should be cancelled. You cannot "uncancel"
	 *         events, so returning true when the event is already cancelled
	 *         does nothing.
	 */
	public boolean onResourceProcess(Resource resource, LocalWorld world, Random random, boolean villageInChunk, int chunkX, int chunkZ,
			boolean isCancelled) {
		return true;
	}
