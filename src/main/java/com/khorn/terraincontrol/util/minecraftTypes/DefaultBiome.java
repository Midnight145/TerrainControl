...
public enum DefaultBiome {
	...
	/**
	 * Default ID, proper name and default settings class for a Mushroom Island
	 * biome
	 */
	...
	/**
	 * Default ID, proper name and default settings class for an Extreme Hills Edge
	 * biome
	 */
	...
	/**
	 * Default ID, proper name and default settings class for... I think you
	 * understand it now.
	 */
	JUNGLE_EDGE(23, "JungleEdge", JungleEdge.class), DEEP_OCEAN(24, "Deep Ocean", DeepOcean.class),
	STONE_BEACH(25, "Stone Beach", StoneBeach.class), COLD_BEACH(26, "Cold Beach", ColdBeach.class),
	BIRCH_FOREST(27, "Birch Forest", BirchForest.class), BIRCH_FOREST_HILLS(28, "Birch Forest Hills", BirchForestHills.class),
	ROOFED_FOREST(29, "Roofed Forest", RoofedForest.class), COLD_TAIGA(30, "Cold Taiga", ColdTaiga.class),
	COLD_TAIGA_HILLS(31, "Cold Taiga Hills", ColdTaigaHills.class), MEGA_TAIGA(32, "Mega Taiga", MegaTaiga.class),
	MEGA_TAIGA_HILLS(33, "Mega Taiga Hills", MegaTaigaHills.class), EXTREME_HILLS_PLUS(34, "Extreme Hills+", ExtremeHillsPlus.class),
	SAVANNA(35, "Savanna", Savanna.class), SAVANNA_PLATEAU(36, "Savanna Plateau", SavannaPlateau.class), MESA(37, "Mesa", Mesa.class),
	MESA_PLATEAU_FOREST(38, "Mesa Plateau F", MesaPlateauForest.class), MESA_PLATEAU(39, "Mesa Plateau", MesaPlateau.class),
	SUNFLOWER_PLAINS(129, "Sunflower Plains", SunflowerPlains.class), DESERT_MOUNTAINS(130, "Desert M", DesertMountains.class),
	EXTREME_HILLS_MOUNTAINS(131, "Extreme Hills M", ExtremeHillsMountains.class), FLOWER_FOREST(132, "Flower Forest", FlowerForest.class),
	TAIGA_MOUNTAINS(133, "Taiga M", TaigaMountains.class), SWAMPLAND_MOUNTAINS(134, "Swampland M", SwamplandMountains.class),
	ICE_PLAINS_SPIKES(140, "Ice Plains Spikes", IcePlainsSpikes.class), JUNGLE_MOUNTAINS(149, "Jungle M", JungleMountains.class),
	...
	COLD_TAIGA_MOUNTAINS(158, "Cold Taiga M", ColdTaigaMountains.class), MEGA_SPRUCE_TAIGA(160, "Mega Spruce Taiga", MegaSpruceTaiga.class),
	// MEGA_SPRUCE_TAIGA_HILLS(161, "Mega Spruce Taiga Hills",
	// MegaSpruceTaigaHills.class),
	// ^ This biome is bugged and doesn't generate properly in Minecraft
	// It registers itself with the wrong id -
	// net.minecraft.server.BiomeBase.getBiome(161)
	...
	SAVANNA_PLATEAU_MOUNTAINS(164, "Savanna Plateau M", SavannaPlateauMountains.class), MESA_BRYCE(165, "Mesa (Bryce)", MesaBryce.class),
	...
	public BiomeLoadInstruction getLoadInstructions(MojangSettings mojangSettings, int maxWorldHeight) {
		try {
			StandardBiomeTemplate template = (StandardBiomeTemplate) this.defaultSettingsClass.getConstructors()[0]
					.newInstance(mojangSettings, maxWorldHeight);
	...
	public static boolean Contain(String name) {
		for (DefaultBiome biome : DefaultBiome.values()) {
			if (biome.Name.equals(name)) { return true; }
		}
		return false;
	}
	...
	public static Integer getId(String name) {
		for (DefaultBiome biome : DefaultBiome.values()) {
			if (biome.Name.equals(name)) { return biome.Id; }
		}
		return null;
	}
