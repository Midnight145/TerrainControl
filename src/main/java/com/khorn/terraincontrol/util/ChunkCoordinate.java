 ...
 *
 * <p>
 * Minecraft uses two coordinate systems: chunk coords and block coords.
 ...
 *
 * <p>
 * This class contains some helper methods to switch from/to block
 * coordinates.
 */
public class ChunkCoordinate {
	...
	public boolean equals(Object otherObject) {
		...
		if (!(otherObject instanceof ChunkCoordinate)) { return false; }
		ChunkCoordinate otherChunkCoordinate = (ChunkCoordinate) otherObject;
		if (otherChunkCoordinate.chunkX != chunkX) { return false; }
		if (otherChunkCoordinate.chunkZ != chunkZ) { return false; }
		return true;
	}
	 ...
	 *
	 * <p>
	 * During terrain population, these four chunks are
	 ...
	 *
	 * <p>
	 * This method essentially returns the top left chunk for the whole
	 ...
	 * @return The x position.
	 */
	public int getBlockXCenter() { return chunkX * CHUNK_X_SIZE + CHUNK_HALF_X_SIZE; }
	 ...
	 * @return The z position.
	 */
	public int getBlockZCenter() { return chunkZ * CHUNK_Z_SIZE + CHUNK_HALF_Z_SIZE; }
	 ...
	 */
	public int getBlockX() { return chunkX * CHUNK_X_SIZE; }
	 ...
	 */
	public int getBlockZ() { return chunkZ * CHUNK_Z_SIZE; }
	 ...
	 * {@code equals(ChunkCoordinate.{@link #getPopulatingChunk(int, int)
	 * getPopulatingChunk}(blockX,blockZ))}, but
