...
public class BiomeLoadInstruction {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof BiomeLoadInstruction)) { return false; }
		BiomeLoadInstruction other = (BiomeLoadInstruction) obj;
		if (!biomeTemplate.equals(other.biomeTemplate)) { return false; }
	 ...
	 * @return The name.
	 */
	public String getBiomeName() { return name; }
	 ...
	 */
	public StandardBiomeTemplate getBiomeTemplate() { return biomeTemplate; }
