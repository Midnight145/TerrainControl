...
public class BiomeStandardValues extends Settings {
	...
	public static final Setting<String> BIOME_CONFIG_EXTENSION = stringSetting("BiomeConfigExtension", ".bc"),
			BIOME_EXTENDS = stringSetting("BiomeExtends", ""), RIVER_BIOME = stringSetting("RiverBiome", "River"),
	...
	public static final Setting<Integer> BIOME_SIZE = intSetting("BiomeSize", 5, 0, 20),
			BIOME_RARITY = intSetting("BiomeRarity", 100, 0, Integer.MAX_VALUE), SMOOTH_RADIUS = intSetting("SmoothRadius", 2, 0, 32),
			RIVER_WATER_LEVEL = intSetting("RiverWaterLevel", 63, WORLD_DEPTH, WORLD_HEIGHT),
			WATER_LEVEL_MAX = WorldStandardValues.WATER_LEVEL_MAX, WATER_LEVEL_MIN = WorldStandardValues.WATER_LEVEL_MIN;

	public static final Setting<Integer> BIOME_COLOR = colorSetting("BiomeColor", "#ffffff"),
			SKY_COLOR = colorSetting("SkyColor", "#7BA5FF"), WATER_COLOR = colorSetting("WaterColor", "#FFFFFF"),
			GRASS_COLOR = colorSetting("GrassColor", "#000000"), FOLIAGE_COLOR = colorSetting("FoliageColor", "#000000");

	public static final Setting<List<String>> ISLE_IN_BIOME = stringListSetting("IsleInBiome", "Ocean"),
			BIOME_IS_BORDER = stringListSetting("BiomeIsBorder"), NOT_BORDER_NEAR = stringListSetting("NotBorderNear"),
			BIOME_OBJECTS = stringListSetting("BiomeObjects");

	public static final Setting<Double> VOLATILITY_1 = doubleSetting("Volatility1", 0, -1000, 1000),
	...
	public static final Setting<LocalMaterialData> STONE_BLOCK = new MaterialSetting("StoneBlock", DefaultMaterial.STONE),
			...
			GROUND_BLOCK = new MaterialSetting("GroundBlock", DefaultMaterial.DIRT), WATER_BLOCK = WorldStandardValues.WATER_BLOCK,
	...
	public static final Setting<Float> BIOME_TEMPERATURE = floatSetting("BiomeTemperature", 0.5f, 0, 2),
			BIOME_WETNESS = floatSetting("BiomeWetness", 0.5f, 0, 1), BIOME_HEIGHT = floatSetting("BiomeHeight", 0.1f, -10, 10),
			BIOME_VOLATILITY = floatSetting("BiomeVolatility", 0.3f, -1000, 1000), RIVER_HEIGHT = floatSetting("RiverHeight", -1, -10, 10),
	...
	public static final Setting<List<WeightedMobSpawnGroup>> SPAWN_MONSTERS = mobGroupListSetting("SpawnMonsters"),
			SPAWN_CREATURES = mobGroupListSetting("SpawnCreatures"), SPAWN_WATER_CREATURES = mobGroupListSetting("SpawnWaterCreatures"),
