...
public class FileSettingsWriter implements SettingsWriter {
	...
	public static final void writeToFile(ConfigFile config, File file, ConfigMode configMode) {
		if (configMode == ConfigMode.WriteDisable) { return; }
	...
	private void checkState() throws IllegalStateException {
		if (writer == null) { throw new IllegalStateException("Not started writing yet"); }
	}
	...
	public void close() {
		...
		try {
			...
			TerrainControl.log(LogMarker.WARN, "Failed to close file {} ({})", file.getAbsolutePath(), e.getMessage());
		}
		writer = null;
	}
