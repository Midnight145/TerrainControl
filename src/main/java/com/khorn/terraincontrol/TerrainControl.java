...
public class TerrainControl {
	 ...
	 */
	public static BiomeModeManager getBiomeModeManager() { return engine.getBiomeModeManager(); }
	 ...
	 */
	public static ConfigFunctionsManager getConfigFunctionsManager() { return engine.getConfigFunctionsManager(); }
	 ...
	 */
	public static CustomObjectManager getCustomObjectManager() { return engine.getCustomObjectManager(); }
	 ...
	 * @return The engine
	 */
	public static TerrainControlEngine getEngine() { return engine; }
	 ...
	 */
	public static PluginConfig getPluginConfig() { return engine.getPluginConfig(); }
	...
	public static void setEngine(TerrainControlEngine engine) {
		if (TerrainControl.engine != null) { throw new IllegalStateException("Engine is already set."); }
