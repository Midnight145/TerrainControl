...
public class BO2Settings extends Settings {
	public static final Setting<Boolean> SPAWN_SUNLIGHT = booleanSetting("spawnSunlight", true),
			SPAWN_DARKNESS = booleanSetting("spawnDarkness", true), SPAWN_WATER = booleanSetting("spawnWater", false),
			SPAWN_LAVA = booleanSetting("spawnLava", false), SPAWN_ABOVE_GROUND = booleanSetting("spawnAboveGround", false),
			SPAWN_UNDER_GROUND = booleanSetting("spawnUnderGround", false), UNDER_FILL = booleanSetting("underFill", true),
			RANDON_ROTATION = booleanSetting("randomRotation", true), DIG = booleanSetting("dig", false),
			TREE = booleanSetting("tree", false), BRANCH = booleanSetting("branch", false),
			DIGGING_BRANCH = booleanSetting("diggingBranch", false), NEEDS_FOUNDATION = booleanSetting("needsFoundation", true);
	...
	public static final Setting<Integer> RARITY = intSetting("rarity", 100, 1, 1000000),
			...
			GROUP_SEPERATION_MAX = intSetting("groupSeparationMax", 5, 0, 100), BRANCH_LIMIT = intSetting("branchLimit", 6, 0, 100);
	...
	public static final Setting<List<String>> GROUP_ID = stringListSetting("groupId"),
