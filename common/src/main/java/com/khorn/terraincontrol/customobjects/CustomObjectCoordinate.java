...
public class CustomObjectCoordinate {
	 ...
	 * @return The object.
	 */
	public CustomObject getObject() { return object; }
	 ...
	 */
	public StructuredCustomObject getStructuredObject() { return (StructuredCustomObject) object; }
	...
	public boolean spawnWithChecks(LocalWorld world, StructurePartSpawnHeight height, Random random) {
		...
		if (!object.canSpawnAt(world, rotation, x, y, z)) { return false; }
	...
	public boolean equals(Object otherObject) {
		...
		if (!(otherObject instanceof CustomObjectCoordinate)) { return false; }
		CustomObjectCoordinate otherCoord = (CustomObjectCoordinate) otherObject;
		if (otherCoord.x != x) { return false; }
		if (otherCoord.y != y) { return false; }
		if (otherCoord.z != z) { return false; }
		if (!otherCoord.rotation.equals(rotation)) { return false; }
		if (!otherCoord.object.getName().equals(object.getName())) { return false; }
		return true;
	}
