...
public enum MobNames {
	BAT("Bat", "bat"), BLAZE("Blaze", "blaze"), CAVE_SPIDER("CaveSpider", "cavespider", "cave_spider"), CHICKEN("Chicken", "chicken"),
	COW("Cow", "cow"), CREEPER("Creeper", "creeper"), ENDER_DRAGON("EnderDragon", "enderdragon", "ender_dragon"),
	ENDERMAN("Enderman", "enderman"), GHAST("Ghast", "ghast"), GIANT("Giant", "giant", "giantzombie", "zombiegiant"),
	...
	OCELOT("Ozelot", "ozelot", "Ocelot", "ocelot"), PIG("Pig", "pig"), PIG_ZOMBIE("PigZombie", "pigzombie", "pig_zombie"),
	...
	public static String toInternalName(String alias) {
		if (mobAliases.containsKey(alias)) { return mobAliases.get(alias); }
		return alias;
	}
	 ...
	 *
	 * @param internalMinecraftName The internal Minecraft mob id, for example
	 *                              Ozelot
	 ...
	 */
	public String getInternalName() { return this.internalMinecraftName; }
}