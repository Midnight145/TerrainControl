...
public class OreGen extends Resource {
	...
	public String makeString() {
		return "Ore(" + material + "," + maxSize + "," + frequency + "," + rarity + "," + minAltitude + "," + maxAltitude
	...
	public boolean equals(Object other) {
		...
		return this.maxSize == compare.maxSize && this.minAltitude == compare.minAltitude && this.maxAltitude == compare.maxAltitude
