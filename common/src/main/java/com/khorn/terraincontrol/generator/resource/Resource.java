...
public abstract class Resource extends ConfigFunction<BiomeConfig> {
	...
	public final void process(LocalWorld world, Random random, boolean villageInChunk, ChunkCoordinate chunkCoord) {
		...
		if (!isValid() || !TerrainControl.fireResourceProcessEvent(this, world, random, villageInChunk, chunkCoord.getChunkX(),
	 ...
	 */
	public LocalMaterialData getMaterial() { return material; }
	...
	public boolean equals(Object other) {
		...
		if (this.material == null) { if (compare.material != null) { return false; } }
