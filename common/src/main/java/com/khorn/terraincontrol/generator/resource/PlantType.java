...
public class PlantType {
	...
	public void spawn(LocalWorld world, int x, int y, int z) {
		...
		if (topBlock != null) { world.setBlock(x, y + 1, z, topBlock); }
	}
	...
	public boolean equals(Object obj) {
		...
		if (bottomBlock == null) {
			if (other.bottomBlock != null) { return false; }
		}
		else if (!bottomBlock.equals(other.bottomBlock)) { return false; }
		if (topBlock == null) {
			if (other.topBlock != null) { return false; }
		}
		else if (!topBlock.equals(other.topBlock)) { return false; }
		return true;
	}
	 ...
	 */
	public LocalMaterialData getBottomMaterial() { return bottomBlock; }
	 ...
	 */
	public LocalMaterialData getTopMaterial() { return topBlock; }
