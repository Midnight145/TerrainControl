 ...
 *
 * <p>
 * Null values are not permitted anywhere (parameters, return values) in
 * this class, unless noted otherwise.
 *
 * <p>
 * All data manipulations methods must not actually save any of the data.
...
public interface SettingsReader {
	 ...
	 *                 {@link #getConfigFunctions(Object)}.
	 ...
	 *
	 * <p>
	 * In general, this method should be avoided. The settings and config
	 * functions system should already fit most use cases. The names of all
	 * settings should be known beforehand.
	 *
	 * <p>
	 * One use case of this method is to parse some kind of legacy config
	 * file with dynamic keys, like a BO2 file.
	 *
	 * <p>
	 * Implementations are allowed to return an empty collection, even
	 ...
	 *
	 * <p>
	 * This is used for backwards compatibility of settings files. When a
	 ...
	 *
	 * <p>
	 * An example of this is SurfaceAndGroundControl, that should not
