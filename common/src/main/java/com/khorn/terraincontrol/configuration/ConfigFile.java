...
public abstract class ConfigFile {
	...
	public void write(SettingsWriter writer, ConfigMode configMode) throws IOException {
		if (configMode == ConfigMode.WriteDisable) { throw new IOException("ConfigMode is " + ConfigMode.WriteDisable); }
	...
	protected int higherThan(int currentValue, int minimumValue) {
		if (currentValue <= minimumValue) { return minimumValue + 1; }
		return currentValue;
	}
	 ...
	 */
	public String getName() { return reader.getName(); }
	 ...
	 * @return The file.
	 */
	public File getFile() { return reader.getFile(); }
