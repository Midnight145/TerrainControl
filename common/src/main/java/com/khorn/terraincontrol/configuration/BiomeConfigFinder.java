...
public class BiomeConfigFinder {
	 ...
	 * 
	 * @param worldConfig                 The world config, passed to created the
	 *                                    biome
	 *                                    configs.
	...
	public Map<String, BiomeConfig> loadBiomesFromDirectories(Collection<File> directories, Collection<BiomeLoadInstruction> biomesToLoad) {
		...
		for (File directory : directories) {
			...
			if (directory.exists()) { loadBiomesFromDirectory(biomeConfigsStore, directory, remainingBiomes); }
		}
	 ...
	 */
	private void loadBiomesFromDirectory(Map<String, BiomeConfig> biomeConfigsStore, File directory,
			Map<String, BiomeLoadInstruction> remainingBiomes) {
