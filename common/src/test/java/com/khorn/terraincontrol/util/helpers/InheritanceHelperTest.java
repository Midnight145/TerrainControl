...
public class InheritanceHelperTest {
	...
	public void testEmptyChildList() {
		...
		List<Resource> parentList = Arrays.asList(Resource.createResource(config, DungeonGen.class, 4, 100, 10, 30),
	...
	public void testOverrides() {
		...
		List<Resource> childList = Arrays.asList(Resource.createResource(config, DungeonGen.class, 1, 50, 30, 60));
